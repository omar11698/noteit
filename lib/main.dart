...
void main() async {
  ...
  runApp(ChangeNotifierProvider(create: (BuildContext context) => ThemeProvider() ,child: const MyApp()));
}
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
        ...
        child: ChangeNotifierProvider(
          ...
          child: ChangeNotifierProvider(
            create: (BuildContext context) =>
                FontButtonProvider(isToolBoxVisible: false, selectedFont: MyGoogleFonts.abel),
